...
<%@ page import="com.taglib.CourseTable" %>
	...
	<div class="content">
   	<div align="center"><br>
		...
		<%  CourseTable courseTable = new CourseTable();
			if (!courseTable.getCourseList().isEmpty()) {
			    for (Course course : courseTable.getCourseList()) { %>
			        <p><a href="/course.jsp?id=<%=course.getId()%>"><%=course.getTitle()%></a>&nbsp;授课老师：<%=course.getTeacherName()%></p>
			<%	}
			}%>
   	</div>
   	<!-- end .content --></div>
